...
# Supported: mobilenetv3large-deeplabv3 | mobilenetv3large-mask2former | mobilenetv3large-segformer | resnet50-segformer | resnet50-deeplabv3 | resnet50-mask2former
...
def _resolve_model_path(model_script_dir: str) -> str:
    ...
    if script_name == "mobilenetv3large-mask2former":
        ...
        candidates = [
            ...
            os.path.join(model_script_dir, "mobilenetv3large-segformerb4-512x512.pt"),
            os.path.join(model_script_dir, "mobilenetv3large-segformerb4-384x384.pt"),
            os.path.join(MODEL_DIR, "mobilenetv3large-segformerb4.pt"),
            os.path.join(MODEL_DIR, "mobilenetv3large-segformerb4-512x512.pt"),
            os.path.join(MODEL_DIR, "mobilenetv3large-segformerb4-384x384.pt"),
        ]
        for p in candidates:
            if os.path.isfile(p):
                return p
        ...
        candidates = [
            os.path.join(model_script_dir, "resnet50-deeplabv3.pt"),
            os.path.join(model_script_dir, "resnet50-deeplabv3-512x512.pt"),
            os.path.join(model_script_dir, "resnet50-deeplabv3-384x384.pt"),
            os.path.join(MODEL_DIR, "resnet50-deeplabv3.pt"),
            os.path.join(MODEL_DIR, "resnet50-deeplabv3-512x512.pt"),
            os.path.join(MODEL_DIR, "resnet50-deeplabv3-384x384.pt"),
        ]
        for p in candidates:
            if os.path.isfile(p):
                return p
        ...
        candidates = [
            os.path.join(model_script_dir, "resnet50-mask2former.pt"),
            os.path.join(model_script_dir, "resnet50-mask2former-512x512.pt"),
            os.path.join(model_script_dir, "resnet50-mask2former-384x384.pt"),
            os.path.join(MODEL_DIR, "resnet50-mask2former.pt"),
            os.path.join(MODEL_DIR, "resnet50-mask2former-512x512.pt"),
            os.path.join(MODEL_DIR, "resnet50-mask2former-384x384.pt"),
        ]
        for p in candidates:
            if os.path.isfile(p):
                return p
